...
public partial class Motor : Component
{
	...
	private void Update_Movement_Settings()
	{
		...
		//	4 -> turn left  6 -> trun right
		//	7 -> fwd left   1 -> bck left
		//	9 -> fwd right  3 -> bck right
		//
		//	./5 -> break/wait
		*/		
		...
		float flt_Move_Dist = 100.0f;	// the distance that the rover moves for each forward/backward command // in world units
